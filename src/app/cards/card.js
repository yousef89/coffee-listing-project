            ...
            <div className="flex items-center text-[13px] pt-2">
                ...
                {rating == null ? (
                    <>
                        ...
                        <p className="text-[#6F757C] pl-1">No ratings</p>
                    </>
                ):(
                    <>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p className="text-white pl-1">{parseFloat(rating)}<span className="text-[#676E73] pl-1 ">({votes} votes)</span></p>
                    </>
                )}
                {available == false ? (
                    <>
                        <p className="text-[#ED735D] ml-auto">Sold out</p>
                    </>
                ):(
                    <></>
                )}
